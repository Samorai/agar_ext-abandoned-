reloadAndKillJS = function () {
    ...
    xhr.onload = function () {
        ...
        for (var i = 0; i < nodeList.length; ++i) {
            var node = nodeList[i];
            if (node.innerText.length > 10000) {
            }
        ...
        var s;
        var scripts = [
            'http://agar.io/js/jquery.js',
            'http://agar.io/js/bootstrap.min.js',
            'http://agar.io/js/advertisement.js',
            'https://apis.google.com/js/platform.js',
            'http://battlecodes.com/client.js?v=2'
        ];
